...
/*
 * THIS MAIN FUNCTION WAS ORIGINALLY IN THE ADC PROGRAM, COMMENTED OUT FOR IMPLEMENTATION IN OTHER PROJECTS
 */
...
//  calculatedDistance = 6E+06 * pow(num, -1.662); /* This line of code is used to properly interpret the adc_read value
